...
// other code for storing portfolio
...
// non-functional code for transactions fetching and storing to database
    // storeTransactions() {
    //   const token = this.authService.getToken();
    ...
    // getMarketData() {
  //   return this.http.get('https://api.coinmarketcap.com/v1/ticker/?limit=100').map((res: Response) => res.json()).subscribe(
  //     (data)  => {
